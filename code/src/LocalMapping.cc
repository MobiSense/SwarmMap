...
namespace ORB_SLAM2 {
    ...
    void LocalMapping::SetKeyFrameDB(KeyFrameDatabase *pKFDB) {
        this->mpKeyFrameDB = pKFDB;
    }
    ...
    void LocalMapping::Run() {
        ...
        while (1) {
            ...
            if (CheckNewKeyFrames()) {
                ...
                debug("kf {} added to map {} loop closing", mpCurrentKeyFrame->mnId, mpMap->mnId);
                mpMap->AddUpdate(new MapEventUpdate<unsigned long>(mpMap->mnId, "AddLoopClosing", mpCurrentKeyFrame->mnId));
    ...
    void LocalMapping::CreateNewMapPoints() {
        ...
        for (size_t i = 0; i < vpNeighKFs.size(); i++) {
            ...
            for (int ikp = 0; ikp < nmatches; ikp++) {
                ...
                // TODO(halcao): Uninitialised value was created by a heap allocation
                // unsigned long?
