...
namespace ORB_SLAM2 {
    ...
    void Viewer::Run() {
        ...
        pangolin::RegisterKeyPressCallback('s', [this](){
            this->mpMapDrawer->frameScaleFactor *= 0.9;
        });
        // scale up
        pangolin::RegisterKeyPressCallback('d', [this](){
            this->mpMapDrawer->frameScaleFactor *= 1.1;
        });
...
//    cv::namedWindow("ORB-SLAM2: Current Frame", cv::WINDOW_OPENGL);
        ...
        while (1) {
            ...
            mpMapDrawer->DrawCurrentCamera(menuShowKeyFrames, Twc);
