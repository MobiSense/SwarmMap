...
#ifndef EDGE_SLAM_DYNAMICEXTRACTOR_H
#define EDGE_SLAM_DYNAMICEXTRACTOR_H
...
//        void extractMask(const cv::Mat &frame, cv::Mat &dynamic_mask);
        void extractMaskDirect(const cv::Mat &frame, cv::Mat &dynamic_mask);
        void extractMaskDirect(const std::vector<cv::Mat>& frames, std::vector<cv::Mat> &masks);
...
#endif //EDGE_SLAM_DYNAMICEXTRACTOR_H
